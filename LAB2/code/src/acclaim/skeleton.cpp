...
void Skeleton::setEnd(int end) { 
    if (currentEndBone != end) {
        ...
        if (end >= 24 && end <= 30) {
            ...
            currentBasePos = bones[rootIdx].end_position;
            ...
            rootIdx = 7;
            currentBasePos = bones[rootIdx].start_position;
        } else if (end >= 1 && end <= 4) {
            rootIdx = 2;
            currentBasePos = bones[rootIdx].start_position;
        }
...
Eigen::Vector4d Skeleton::getCurrentBasePos() { return currentBasePos; }
